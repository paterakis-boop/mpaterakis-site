(function () {
  ...
  var dict = {
    el: {
      ...
      "areas.8.t": "Αγοραπωλησίες ακινήτων",
      "areas.8.b": "Έλεγχος τίτλων, σύνταξη συμβολαίου και εκπροσώπηση στον συμβολαιογράφο και στο Κτηματολόγιο.",
    ...
    en: {
      ...
      "areas.8.t": "Real-estate sales",
      "areas.8.b": "Title review, drafting of the contract and representation before the notary and the Cadastre.",
