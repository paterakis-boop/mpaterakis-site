(function () {
  ...
  var dict = {
    el: {
      ...
      "contact.address": "Astron Center<br>Θερμοπυλών 1, 6ος<br>671 31 Ξάνθη",
      "contact.hours": "Δευτέρα – Παρασκευή<br>8:30–17:30",
      "footer.firm": "Δικηγορικό γραφείο Πατεράκη Μιχαήλ και Συνεργατών",
      "footer.privacy": "Πολιτική απορρήτου",
      "pbox.close": "Κλείσιμο",
      "title.peitharxiko": "Πειθαρχικό δίκαιο δημοσίων υπαλλήλων: ΕΔΕ, απολογία, προσφυγή | Δικηγορικό γραφείο Πατεράκη",
      ...
      "apo.3.date": "Τριμελές Πλημμελειοδικείο Ξάνθης · Ποινή 4 ετών και 10 μηνών",
    ...
    en: {
      ...
      "pbox.close": "Close",
      "title.peitharxiko": "Disciplinary law for public servants | Paterakis Law Office, Xanthi",
      ...
      "apo.3.date": "Three-member Misdemeanours Court of Xanthi · Sentence of 4 years and 10 months",
